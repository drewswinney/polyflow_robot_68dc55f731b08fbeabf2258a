...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "68dc55f731b08fbeabf2258a";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  environment.systemPackages = with pkgs; with rosPackages.humble; [ vim git wget inetutils ros-base ros-core gh pip colcon ];
  ...
  systemd.services.polyflow_startup = {
    ...
    serviceConfig = {
      ...
      DIRECTORY="/home/${user}/polyflow_robot_68dc55f731b08fbeabf2258a"
      if [[ -d "$DIRECTORY" ]];
        then
          cd "$DIRECTORY"
          ...
          ${pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_68dc55f731b08fbeabf2258a.git
          chown -R ${user}:users /home/${user}/polyflow_robot_68dc55f731b08fbeabf2258a
          
          cd /home/${user}/polyflow_robot_68dc55f731b08fbeabf2258a/workspace/src/webrtc
          pip install -r requirements.txt

          cd /home/${user}/polyflow_robot_68dc55f731b08fbeabf2258a/workspace
